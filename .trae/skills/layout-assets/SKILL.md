...
.header {
  ...
  // background-size: 100% 100%; // 严禁设置
  // background-position: center;// 严禁设置
}
```
...
- **Header 拉伸禁令**：在 `header.vue` 中应用 `top.png` 时，**严禁**设置 `background-size: 100% 100%` 或 `background-position` 属性，以防背景图拉伸变形。
